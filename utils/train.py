...
def train_loop(model: nn.Module, 
    ...
    return {
        ...
        "y_pred": y_pred_train,
        "y_true": y_true_train,
        "y_pred_logits": y_pred_logits_train
    }
...
def val_loop(model: nn.Module,
    ...
    return {
        ...
        "y_pred": y_pred_val,
        "y_true": y_true_val,
        "y_pred_logits": y_pred_logits_val
    }
...
def test_loop(model: nn.Module,
    ...
    with torch.inference_mode():
        ...
        final_y_pred_logits = torch.cat(y_pred_logits_test).cpu().numpy()
    
    return {
        "y_pred": final_y_pred_test,
        "y_true": final_y_true_test,
        "y_pred_logits": final_y_pred_logits
    }
...
def train_and_eval_model(
    ...
    history = {
        "train_loss": [], "val_loss": [],
        "train_pred": [], "val_pred": [],
        "train_pred_logits":[], "val_pred_logits": [],
        "train_true": [], "val_true": []
    }
    ...
    for epoch in range(epochs):
        ...
        train_pred_logits = torch.cat(train_data["y_pred_logits"])
        ...
        history["train_pred_logits"].append(train_pred_logits.cpu())
        history["val_pred_logits"].append(val_pred_logits.cpu())
